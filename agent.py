...
async def generate_response_stream(messages, use_openrouter=False, api_key=None):
    if messages and messages[0].get("role") != "system":
        system_prompt = (
            ...
            "2. عند البحث: اكتب جملة عربية طبيعية قصيرة واحدة فقط تصف موقفاً أو شعوراً واحداً — كوصف لمشهد (مثال صحيح: 'أجلس وحدي في الليل وأشعر بالحزن الشديد'، أو 'أشتاق إلى وطني وأنا بعيد عنه'). ممنوع الجمع بين عدة مشاعر أو تجميع كلمات مترادفة في جملة واحدة (مثال خاطئ: 'الكبرياء والانتماء والعزة والفخر والشموخ والتراث') لأن ذلك يشتت البحث ويُعيد أبياتاً عن معانٍ أخرى.\n"
